...
import { SignoDialogoComponent } from './pages/signo/signo-edicion/signo-dialogo/signo-dialogo.component';
...
@NgModule({
  declarations: [
    ...
    SignoDialogoComponent    
  ],
  entryComponents: [MedicoDialogoComponent, DialogoComponentComponent, SignoDialogoComponent],
